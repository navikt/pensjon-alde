...
import type {
    LivsvarigAfpOffentligVurdering
} from "~/behandlinger/alderspensjon-soknad/livsvarigAfpOffentlig-avvik/livsvarigafp-types";
...
export default function LivsvarigAfpOffentligAvvik() {
    ...
    let {tpliste} = useLoaderData<typeof loader>();
